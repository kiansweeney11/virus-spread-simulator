...
pd.DataFrame.from_records(deaths_lst, columns=['time', 'deaths']).to_csv(os.path.join('./data-analysis/high-vaccine/', 'deaths.csv'), index=False)
pd.DataFrame.from_records(infections_lst, columns=['time', 'infections']).to_csv(os.path.join('./data-analysis/high-vaccine/', 'infections.csv'), index=False)
pd.DataFrame.from_records(vaccine_lst, columns=['time', 'vaccinated']).to_csv(os.path.join('./data-analysis/high-vaccine/', 'vaccine.csv'), index=False)
pd.DataFrame.from_records(reinfection_lst, columns=['time', 'reinfections']).to_csv(os.path.join('./data-analysis/high-vaccine/', 'reinfections.csv'), index=False)